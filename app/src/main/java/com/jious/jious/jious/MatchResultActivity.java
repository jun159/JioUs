...
public class MatchResultActivity extends AppCompatActivity {
    ...
    private List<Event> getEventList() {
        ...
        events.add(new Event(R.drawable.profile_kind, "SPRING FIELD MATCH", "SAFRA TPY", "1.3km", " 29 Jun 2016, Tuesday, 7:00pm",
                "Ahmad Sathin", 8, 12, 2, 3, false));
        events.add(new Event(R.drawable.profile_2, "TPY V.S AMK FRIENDS MATCH", "AMK ITE CENTRAL", "6.5km ", " 02 July 2016, Saturday, 9:00am",
                "Lawrance Tee", 8, 12, 5, 6, false));
        events.add(new Event(R.drawable.profile_hdb, "HAPPY TIONG BARU SOCCER", "REDHILL SEC SCH", "12km", " 03 July 2016, Sunday, 2:00pm",
                "Steve Jobs", 8, 12, 3, 7, false));
        events.add(new Event(R.drawable.justin, "TOA PAYOH SOCCER TEAM", "BISHAN PARK SEC SCH", "3.2km", " 26 July 2016, Sunday, 6:00pm",
                "James Lee", 8, 12, 1, 1, false));
